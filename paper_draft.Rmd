...
Kelps are a cold-water species of large brown algae, belonging to the order Laminariales [@Kelly 2005]. They are regarded as ecosystem engineers, providing a 3-dimensional habitat for a variety of fauna and flora. In addition, kelp ecosystems host a number of economically important species such as lobster, abalone and fish [@Dayton1985; @Steneck2002]. Various abiotic (e.g. light, wave exposure, sedimentation) and biotic (e.g. grazing) factors structure kelp forests [@Devinny1978; @Dayton1992; @Utter1996; @Toohey2004; @Rothman2006; @Sjøtun2006; @Wernberg2008; @Pedersen2012]. Variations in these factors ultimately affects the way kelp-associated benthos communities are structured [@Dayton1985; @Guimaraes1996; @Wernberg2008; @Wernberg 2009]
.
...
```{r biomass barplot, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap='Comparison of raw biomass species data between sites. Graph A represents flora and graph B represents fauna.'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap= 'Multidimensional scaling of flora and fauna communities respectively.'}
ggarrange(nmds1_plot, nmds2_plot, ncol = 2, nrow = 1, labels = "AUTO", align = "none")
```
